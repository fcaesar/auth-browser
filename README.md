# @fcaesar/auth-browser

This is a customized fork of @fellow/auth-browser.

Specifically it sets prefersEphemeralWebBrowserSession = true on the ASWebAuthenticationSession.
...
```bash
npm install fcaesar/auth-browser
npx cap sync
```
...
```typescript
import { AuthBrowser } from '@fcaesar/auth-browser';
